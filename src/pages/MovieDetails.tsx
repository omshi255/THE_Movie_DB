...
const ArrowButton = ({
  ...
  <button
    onClick={onClick}
    className={`absolute top-1/2 -translate-y-1/2 z-10 bg-black/70 hover:bg-black text-white rounded-full w-7 h-7 sm:w-9 sm:h-9 flex items-center justify-center shadow-lg transition-all duration-200 ${
